...
*  Векторный слой. Одиночный файл или ZIP-архив с одним векторным слоем любого формата, поддерживаемого библиотекой GDAL, например GeoPackage или архив с ESRI Shapefile. `Список поддерживаемых исходных форматов <>`_.
