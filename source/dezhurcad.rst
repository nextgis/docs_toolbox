...
.. note:: Если выписку обработать не удаётся, возможно, дело в том, что она слишком большого размера. Разделите её на отдельыне слои и блоки инструментом `Разбиватор выписок ЕГРН <https://toolbox.nextgis.com/t/egrn_splitter>`_ и уже полученный файл загрузите в инструмент Дежурная кадастровая карта.
