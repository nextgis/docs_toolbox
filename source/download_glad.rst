...
ARD tile name contains the coordinates of the bottom left corner of the grid cell. You can download the :download:`grid <https://glad.umd.edu/users/Potapov/ARD/Global_ARD_tiles.zip>` as ESRI Shapefile.
