Разделение выписки ЕГРН
=======================

Запуск инструмента: https://toolbox.nextgis.com/t/egrn_splitter

Разбивает выписку ЕГРН огромного размера по слоям, уменьшая таким образом объем данных для дальнейшей конвертации. Это позволяет обработать такую выписку инструментами `Дежурная кадастровая карта <https://toolbox.nextgis.com/t/dezhurcad>`_ или `Конвертация данных ЕГРН <https://toolbox.nextgis.com/t/import_egrn>`_.
