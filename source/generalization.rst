...
* Метод. Укажите один из методов упрощения:  ``douglas, douglas_reduction, lang, reduction, reumann``, сглаживания: ``boyle, sliding_averaging, distance_weighting, chaiken, hermite, snakes``, или смещения:  ``displacement`` (подробнее об этих методах см ниже);
