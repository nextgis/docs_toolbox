Продвинутое упрощение векторных данных
=========================================
...
* Векторный слой. Слой в формате GeoPackage, GeoJSON или запакованный в ZIP-архив ESRI Shapefile;
...
* Порог (threshold). Обязательный параметр. Число в диапазоне 0 - 1000000000. Если метод не обращается к данному параметру, укажите любое число;
* Количество точек. Целое число, задаёт количество точек, используемых в некоторых методах. Опциональный параметр. Значение по умолчанию = 7;
* Редукция. Число от 0 до 100. При упрощении: доля сохраняемых точек, в процентах от исходного количества. Опциональный параметр. Значение по умолчанию = 50;
...
* Файл GeoPackage с измененными объектами (геометриями) в ZIP-архиве.
...
.. figure:: _static/generalization_result.png
   ...
   Светлая линия - исходные геометрии, тёмная линия - упрощённые геометрии
