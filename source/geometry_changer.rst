...
* Идентификатор группы, в котором содержится группа слоев - число, которым заканчивается адрес папки в строке браузера. Для Основной группы ресурсов ID=0;
...
* Выберите файл SHP - файл в формате ESRI Shapefile (в виде ZIP-фрхива), который содержит объекты. Параметр обязательный в режимах Add и Change.
