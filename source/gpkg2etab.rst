...
Конверация GeoPackage (GPKG) в Enhanced TAB (NativeX), работает в Mapinfo 15.2 и выше. При конвертации корректно сохраняются символы алфавитов, отличных от латиницы и кирилицы.
