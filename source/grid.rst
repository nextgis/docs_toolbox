...
Download `input dataset <https://nextgis.ru/data/toolbox/grid/grid_inputs.zip>`_ to test the instrument. Step-by-step instructions included.

Get the `output <https://nextgis.ru/data/toolbox/grid/grid_outputs.zip>`_ to additionally check the results.
