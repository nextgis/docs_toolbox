...
* Шаг. Шаг сетки в метрах;
* Режим. Квадраты или точки. По умолчанию: точки;
* Алгоритм обрезки: 1) Обрезать по границе объекта, 2) Оставлять все квадраты, касающиеся объекта, 3) Оставлять все квадраты в охвате объекта;
* Векторный файл полигона границы. Файл с полигонами или мультиполигонами в формате Geopackage. Время расчёта зависит от количества узлов в слое границ
* Охват. Задайте охват на карте или загрузите файл с границами;
* Выравнивание сетки. Выберите, что важнее: 1) Вертикально, лучше видно, но размеры и площадь не совсем соответствуют метрам, или 2) С поворотом - размеры и площадь сохраняются, но сетка будет повёрнута.
