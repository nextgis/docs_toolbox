...
*  Формат выходных данных - GPKG, GeoJSON, ESRI Shapefile или MapInfo TAB. Если оставить поле пустым, используется GPKG.
...
*  Объединять наборы данных - При конвертации нескольких файлов XML слои из разных файлов, но с одинаковым типом объектов будут объединены в один общий слой (исходные результаты конвертации также сохранятся). Не рекомендуется использовать с форматом MapInfo TAB.
