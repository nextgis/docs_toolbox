...
* Идентификатор группы можно указать, где создать группу, в которой будут находиться векторные слои и веб-карта. Номер ресурса группы в Веб ГИС - число, которым заканчивается адрес папки в строке браузера. Если оставить пустым, новя группа будет создана в корне;
