...
* Идентификатор группы. Номер ресурса группы в Веб ГИС - число, которым заканчивается адрес папки в строке браузера. Для Основной группы ресурсов ID=0. В этой группе будет создана карта. Сюда же нужно загрузить векторный слой;
