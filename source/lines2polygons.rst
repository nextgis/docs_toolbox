...
`Набор исходных данных <https://nextgis.ru/data/toolbox/lines2polygons/lines2polygons_inputs.zip>`_ для проверки работы инструмента. Внутри архива пошаговая инструкция.

`Пример результата <https://nextgis.ru/data/toolbox/lines2polygons/lines2polygons_outputs.zip>`_ работы инструмента.
