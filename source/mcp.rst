...
Вы можете добавить в настройках своего AI-агента MCP-сервер NextGIS Toolbox и решать свои геоинформационные задачи прямо в чате.
...
1. Нужна высота н.у.м поселка Барвиха по ALOS. Используй MCP.
