...
`Набор исходных данных <https://nextgis.ru/data/toolbox/mt2report/mt2report_inputs_ru.zip?from-related-tools=1>`_ для проверки работы инструмента. Внутри архива пошаговая инструкция.

`Пример результата <https://nextgis.ru/data/toolbox/mt2report/mt2report_outputs_ru.zip?from-related-tools=1>`_ работы инструмента.
