...
* Начальное время - необязательный параметр. Начальная дата для отчета, указывается в формате ГГГГ-мм-дд;
* Конечное время - необязательный параметр. Конечная дата для отчета, указывается в формате ГГГГ-мм-дд, не менее 28 дней и не более 366 дней от начальной даты.
