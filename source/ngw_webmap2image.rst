...
* Ссылка на Веб карту на платформе NextGIS, например: https://demo.nextgis.com/resource/7796/display?panel=layers. Чтобы получить такую ссылку, откройте веб-карту и скопируйте ссылку из браузера. Карта будет отрисована в том виде, в каком она видна пользователю "Гость", чтобы проверить, что видно на карте, нажмите на иконку пользователя и выберите "Выйти";
