...
* Файл CSV. Таблица содержит названия,учетные номера и номера по лесоустройству следующих атрибутов выделов - регион, лесничество, участковое лесничество, (урочище), квартал, выдел.
