...
Download `input dataset <https://nextgis.ru/data/toolbox/pointcloud2tileset/pointcloud2tileset_inputs.zip>`_ to test the instrument. Step-by-step instructions included.

Get the `output <https://nextgis.ru/data/toolbox/pointcloud2tileset/pointcloud2tileset_outputs.zip>`_ to additionally check the results.
