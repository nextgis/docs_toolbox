...
Download `input dataset <https://nextgis.com/data/toolbox/raster_calculator/raster_calculator_inputs.zip>`_ to test the instrument. Step-by-step instructions included.

Get the `output <https://nextgis.com/data/toolbox/raster_calculator/raster_calculator_outputs.zip>`_ to additionally check the results.
