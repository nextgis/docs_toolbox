...
* Полигональный слой зданий из OSM
* Точечный слой зданий из РеформыЖКХ

На выходе:

* Файл ZIP со слоем полигонов к которым были найдены соответствующие точки из РеформыЖКХ.
* Остальные точки, к которым не были найдены полигоны в OpenStreetMap
