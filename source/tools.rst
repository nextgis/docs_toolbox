...
*  Source raster - RGB, RGBA, single-band gray or single-band with palette GDAL-compatible raster
*  Tileset name - the name that will be used for the file name and for the layer in NGM
