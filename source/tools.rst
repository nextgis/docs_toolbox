...
*  Приложение 3 к лесной декларации - один или несколько png-файлов, упакованных в zip-архив. При экспорте из NextGIS Лес приложение 3 уже имеет формат, готовый к подаче в инстнрумент. Если у вас из NextGIS Лес экспортированы несколько независимых приложений и все они должны входить в одну лесную декларацию, тогда их zip-архивы необходимо добавить в общий zip-архив. После этого zip-архив с входящими в него zip-архивами также можно подавать в инструмент.
