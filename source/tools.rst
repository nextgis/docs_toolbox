...
Кроме того, осуществляется группировка полигонов по заданному параметру через создание отдельного поля с ID, уникальным для каждой группы. При этом геометрия полигонов остается прежней.
