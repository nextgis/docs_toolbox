...
Инструмент позволяет получить сцену Sentinel 2 в естественных цветах по её идентификатору, обрезать её по входной векторной маске и загрузить в Веб ГИС с автоматически созданным стилем.
...
Инструмент создаёт файл pdf из одного, или нескольких png-файлов, в последнем случае все файлы сшиваются в общий pdf-файл. Разработан в первую очередь для пользователей NextGIS Лес. 
...
Создает и обновляет векторный слой в NextGIS Web на базе таблицы Google Sheets

На входе:

*  Адрес Веб ГИС, например: https://sandbox.nextgis.com.
*  Логин пользователя Веб ГИС с правами на изменение.
*  Пароль пользователя Веб ГИС.
...
*  Идентификатор документа Google Sheets или URL целиком. Документ должен быть доступен для чтения по ссылке.
