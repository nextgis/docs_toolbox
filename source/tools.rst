...
Инструмент осуществляет конвертацию выгрузки КПТ Росреестра из формата XML в популярные форматах и с проектом для ГИС.

На входе:

*  zip-архив c zip-архивами выгрузок Росреестра (XML)
*  желаемый формат геоданных - geojson, shp, tab

На выходе:

* zip-архив с проектом QGIS и геоданными

В архиве лежат каталоги: каталог с геоданными в местной системе координат, каталог с геоданными в EPSG:4326 и проект для QGIS с данными в EPSG:4326 с оформлением.
...
.. figure:: _static/ai2geo_before.png
   ...
   Рис. 1. Исходные векторные данные в .ai файле.
...
.. figure:: _static/ai2geo_after.png
   ...
   Рис. 2. Результат работы инструмента: полученные слои загружены в QGIS и отображаются на фоне подложки OSM.
