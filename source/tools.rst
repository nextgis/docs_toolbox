...
Инструмент разработан для пользователей веб-приложения NextGIS Лес. Генерирует лесную декларацию в формате xml на основе файлов, подготовленных в NextGIS Лес и инструменте тулбокса `"Конвертация из png в pdf" <https://toolbox.nextgis.com/operation/ForestPDF/>`_. 
