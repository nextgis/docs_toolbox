...
В архиве лежит каталог с геоданными в местной системе координат, каталог с геоданными в EPSG:4326, и проект для QGIS, который показывает данные в EPSG:4326 с таким же оформлением, как на Публичной Кадастровой Карте Росреестра.
