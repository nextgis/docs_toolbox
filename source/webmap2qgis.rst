...
* Выходной формат. Формат, в котором будут сохранены векторные слои из веб-карты:
    ...
    - CSV
    - DXF
* Идентификатор СК. Идентификатор системы координат для выходного проекта в формате кодов NextGIS Web. По умолчанию ``3857``. Доступные пользователю идентификаторы можно получить по API: ``/api/component/spatial_ref_sys/``.
