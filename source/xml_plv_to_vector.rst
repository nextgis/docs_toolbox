...
`Набор исходных данных <https://nextgis.ru/data/toolbox/xml_plv_to_vector/xml_plv_to_vector_inputs_ru.zip>`_ для проверки работы инструмента. Внутри архива пошаговая инструкция.

`Пример результата <https://nextgis.ru/data/toolbox/xml_plv_to_vector/xml_plv_to_vector_outputs_ru.zip>`_ работы инструмента.
