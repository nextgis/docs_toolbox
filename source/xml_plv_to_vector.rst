...
`Input data set <https://nextgis.ru/data/toolbox/xml_plv_to_vector/xml_plv_to_vector_inputs.zip>`_ to test the tool. The archive contains step-by-step instructions.

`Result example <https://nextgis.ru/data/toolbox/xml_plv_to_vector/xml_plv_to_vector_outputs.zip>`_ of the tool run.
