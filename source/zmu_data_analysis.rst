...
* Web GIS login
* Web GIS Password
* "WRC Data" resource group ID ``Required field`` - ID of the resource group with the deployed WRC system (by default, "WRC Data")
...
Download `input dataset <https://nextgis.com/data/toolbox/zmu_data_analysis/zmu_data_analysis_inputs.zip>`_ to test the instrument. Step-by-step instructions included.

Get the `output <https://nextgis.com/data/toolbox/zmu_data_analysis/zmu_data_analysis_outputs.zip>`_ to additionally check the results.
